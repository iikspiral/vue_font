<template>
  <div class="hello">
    ...
    <el-button type="primary" style="margin-right:10px;" @click="dialogVisible = true"><i
    ...
    <el-dialog
      ...
      <el-upload
        ...
        :on-success="successexceed"
        :limit="1"
        accept=".xls"
        style="text-align: center;">
        <i class="el-icon-upload"></i>
        <div class="el-upload__text"><em>点击上传(或拖拽到虚线区域)</em></div>
      </el-upload>
        <a href="http://10.254.71.154:8080/renren-fast/app/template" download="excleDemo.xls"  style="display:block;text-align:center;">下载模板</a>
        <div class="el-upload__tip" style="text-align:center;">导入文件不能超过5M，仅允许导入“xls”或“xlsx”格式文件！</div>
    </el-dialog>
    <!-- 导出 -->
    <el-button type="primary"><i class="el-icon-download el-icon--right"></i>
      <a href="http://10.254.71.154:8080/renren-fast/app/export" download="excleDemo.xls" class="btn_a">导出</a>
    </el-button>
